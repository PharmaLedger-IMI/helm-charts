...
| volumeSnapshots.preUpgradeEnabled | bool | `false` | Whether to create snapshots before upgrading or not. |
| volumeSnapshots.waitForReadyToUse | bool | `true` | Whether to wait until the VolumeSnapshot is ready to use before upgrading. Note: On first snapshot this may take a while. |
