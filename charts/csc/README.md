...
![Version: 0.4.3](https://img.shields.io/badge/Version-0.4.3-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: csc.0.1.1](https://img.shields.io/badge/AppVersion-csc.0.1.1-informational?style=flat-square)
...
2. Install via helm to namespace `default`
    ...
    ```bash
    helm upgrade my-release-name pharmaledger-imi/csc --version=0.4.3 \
        --install \
...
| config.didDomain | string | `"csc.did.my-company"` | The didDomain, should be domain.company, e.g. csc.rms |
