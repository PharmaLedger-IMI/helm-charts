...
![Version: 0.5.3](https://img.shields.io/badge/Version-0.5.3-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 21.7.1](https://img.shields.io/badge/AppVersion-21.7.1-informational?style=flat-square)
...
```shell
helm upgrade --install quorum-node-0 pharmaledger-imi/quorum-node --version=0.5.3 \
...
1. Install to other namespace
    ...
    ```bash
    helm upgrade my-release-name pharmaledger-imi/quorum-node --version=0.5.3 \
      --install \
