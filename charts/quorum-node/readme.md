...
| blockchain.blockperiod | string | `"3"` | blockhain.blockperiod Quorum node block period |
...
| use_case.joinNetwork.genesis_file_location | string | `"https://raw.githubusercontent.com/bmastahac/usecase-shared-data/master/networks/epi/rms-1/genesis.json"` | genesis file location |
...
| use_case.updatePartnersInfo.shared_data_location | string | `"https://raw.githubusercontent.com/bmastahac/usecase-shared-data/master/networks/epi"` | base URL for shared repository |
